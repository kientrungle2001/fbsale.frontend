<div class="card card-primary">
	<div class="card-header">
	  <h3 class="card-title">Quản trị nhà cung cấp</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
...
<script>
  $(function () {
    fbTable = $("#example1").DataTable({
		ajax: {
		  "url": "<?php echo FBSALE_API_URL ?>/ecommerceproviders/datatable",
		  "type": "POST",
		  "error": function (e) {
		  },
  ...
  function updateStatus(status, id){
  		var url = "<?php echo FBSALE_API_URL ?>/ecommerceproviders/"+id; // the script where you handle the form input.
	    $.ajax({
		    type: "PATCH",
		    url: url,
