<form id="customerForm" ng-show="customer">
	...
	<div class="form-group">
		...
		<select name="address" ng-change="selectAddress(address)" class="form-control" ng-model="customer.address_id"  ng-options="address.id as address.address for address in customer.ref_addresses" placeholder="Chọn địa chỉ">
		</select>
	</div>
	<div class="form-group">
		<button class="btn btn-primary" data-toggle="modal" data-target="#createAddressModal" ng-click="selectedAddress={type:'billing', name: customer.name, email: customer.email, phone: customer.phone}">Tạo Địa Chỉ</button>
		
		<button class="btn btn-primary" data-toggle="modal" data-target="#createAddressModal">Sửa Địa Chỉ</button>
		
		<button class="btn btn-danger" ng-click="deleteAddress()">Xóa Địa Chỉ</button>
	</div>
	...
	<div class="modal-content">
	  ...
	  <div class="modal-body">
		<form class="form">
			...
			<div class="form-group">
				<input type="text" name="address_name" class="form-control" ng-model="selectedAddress.name" placeholder="Họ và tên" />
			</div>
			<div class="form-group">
				<input type="text" name="address_phone" class="form-control" ng-model="selectedAddress.phone" placeholder="Số điện thoại" />
			</div>
			<div class="form-group">
				<input type="text" name="address_email" class="form-control" ng-model="selectedAddress.email" placeholder="Email" />
			</div>
			<div class="form-group">
				<select name="address_type" class="form-control" ng-model="selectedAddress.type" placeholder="Loại địa chỉ">
			...
			<div class="form-group">
				<select type="text" ng-change="selectProvince()" name="address_province_id" class="form-control" ng-model="selectedAddress.province_id" placeholder="Thành phố"
			...
			<div class="form-group">
				<select type="text" ng-change="selectDistrict()" name="address_district_id" class="form-control" ng-model="selectedAddress.district_id" placeholder="Quận huyện"
			...
			<div class="form-group">
				<select type="text" name="address_ward_id" class="form-control" ng-model="selectedAddress.ward_id" placeholder="Phường Xã"
	  ...
	  <div class="modal-footer">
		...
		<button type="button" class="btn btn-primary" ng-click="saveAddress()">Lưu</button>
	  </div>
	</div>
  </div>
</div>