...
<div class="card card-primary">
  <div class="card-header">
	<h3 class="card-title">Thêm Nhãn</h3>
  </div>
  <!-- /.card-header -->
  <!-- form start -->
	...
	<div class="card-body">
	  <div class="row">
		  <div class="form-group col-6">
			<label for="exampleInputEmail1">Tên nhãn</label>
			<input name="name" type="text" class="form-control" id="name" placeholder="Nhãn">
		  </div>
		  
		  <div class="form-group col-6">
			<label for="exampleInputEmail1">Màu sắc</label>
			<input name="color" type="text" class="form-control" id="color" placeholder="màu sắc">
		  </div>
	  </div>
